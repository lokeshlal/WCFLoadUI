...
using Service = Common.Infrastructure.Entities.Service;
...
namespace WCFLoad
{
    ...
    public static class TestEngine
    {
        ...
        public static void InvokeTest(Common.Infrastructure.Entities.Test t, string guid, Value valueFromScenario = null)
        {
        ...
        /// <returns></returns>
        public static string InvokeFunctionalTest(Common.Infrastructure.Entities.Test t, int indexOfValueToUse, string guid, out string input)
        {
            var serviceClient = GetNewServiceProxyInstance(guid);
            MethodInfo methodToInvoke = serviceClient.GetType().GetMethod(t.Service.MethodName);
            MethodInfo closeMethod = serviceClient.GetType().GetMethod("Close");
